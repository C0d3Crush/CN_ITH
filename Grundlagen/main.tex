...
\mysubsubsection{Definition(Wortmengen-Notation)*} 
...
\)
\mysubsubsection{Bemerkung(Endliche längenlexikographische Reihenfolge)*} 
...
\mysubsubsection{Definition(Binärwort-Funktion in längenlexikographischer Reihenfolge)*}
...
\mysubsubsection{Bemerkung(Beziehung zwischen Binärworten und Dezimalzahlen)*}
