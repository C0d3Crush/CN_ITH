...
\begin{itemize}
  ...
  \createDiagram{Breitensuche}{
    \begin{tikzpicture}[  level distance=1.5cm,  level 1/.style={sibling distance=3cm},  level 2/.style={sibling distance=1.5cm},  every node/.style={align=center, text=textcolor}] % Set the text color to the defined dark mode text color
  ...
  \createDiagram{Spurentechnik}
  {
    ...
    \node[cell, right=of cell12, draw=tikzaccentcolor] (cell13) {0};
    \node[cell, right=of cell13, draw=tikzaccentcolor] (cell14) {1};
    \node[cell, right=of cell14, draw=tikzaccentcolor] (cell15) {...};
    
    % Zweites Band
    \node[cell, below=0.5cm of cell11, draw=tikzaccentcolor] (cell21) {...};
    \node[cell, right=of cell21, draw=tikzaccentcolor] (cell22) {1};
    \node[cell, right=of cell22, draw=tikzaccentcolor] (cell23) {0};
    \node[cell, right=of cell23, draw=red] (cell24) {0};
    \node[cell, right=of cell24, draw=tikzaccentcolor] (cell25) {...};
    
    % Drittes Band
    \node[cell, below=0.5cm of cell21, draw=tikzaccentcolor] (cell31) {...};
    \node[cell, right=of cell31, draw=tikzaccentcolor] (cell32) {0};
    \node[cell, right=of cell32, draw=red] (cell33) {1};
    \node[cell, right=of cell33, draw=tikzaccentcolor] (cell34) {1};
    \node[cell, right=of cell34, draw=tikzaccentcolor] (cell35) {...};
    
    % Vertikales Band
    \node[cell, right=5cm of cell22, minimum height=4.13cm, align=center, draw=tikzaccentcolor] (cell41) {...};
    \node[cell, right=0cm of cell41, minimum height=4.13cm, align=center, draw=red] (cell42) {1 \\\\\\ 0 \\\\\\ 1};
    \node[cell, right=0cm of cell42, minimum height=4.13cm, align=center, draw=tikzaccentcolor] (cell43) {1 \\\\\\ 0 \\\\\\ 1};
    \node[cell, right=0cm of cell43, minimum height=4.13cm, align=center, draw=tikzaccentcolor] (cell44) {1 \\\\\\ 0 \\\\\\ 1};
    \node[cell, right=0cm of cell44, minimum height=4.13cm, align=center, draw=tikzaccentcolor] (cell45) {...};
