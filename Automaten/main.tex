...
Wir wollen Turingmahinen un stark einschränken. Wir betrahten ein Modell, das im wesentlichen ohne speicher
...
{
    \begin{tikzpicture}[->,>=latex,shorten >=1pt,auto,node distance=3cm,semithick]
        \tikzstyle{state}=[draw,circle,minimum size=2cm]
