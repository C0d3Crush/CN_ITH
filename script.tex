...
\newif\ifdarkmode
\darkmodetrue % Set default mode to light mode
...
\newcommand{\toggleDarkMode}{%
    \ifdarkmode
        ...
        \colorlet{tikztextcolor}{textcolor} % Use the dark mode text color
        \colorlet{tikzaccentcolor}{accentcolor} % Use the dark mode accent color    
        \pagecolor{background} % Set the background color
        \color{textcolor} % Set the text color
    ...
    \else
        ...
        \tikzset{
            text=black,
            accentcolor=tikzaccentcolor,
            sectioncolor=tikzaccentcolor,
            linkcolor=linkcolor,
        }
    \fi
